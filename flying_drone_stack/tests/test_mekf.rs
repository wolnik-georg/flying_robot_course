...
fn test_mekf_update_flow_changes_velocity_state() {
    ...
    mekf_update_flow(&mut state, 0.0, 0.0, 0.01, params.r_flow, None, params.theta_p);
...
fn test_mekf_update_flow_skips_near_zero_height() {
    ...
    mekf_update_flow(&mut state, 100.0, 100.0, 0.01, params.r_flow, None, params.theta_p);
...
fn test_mekf_update_flow_converges() {
    ...
    for _ in 0..50 {
        mekf_update_flow(&mut state, 0.5, -0.5, 0.01, params.r_flow, None, params.theta_p);
    }
