...
REFERENCE_GAINS = dict(
    ...
    # 2026-09-16: arm/t2t now pinned explicitly too, not left as naindi.rs's old hardcoded
    # default -- see naindi.rs's own comment on why that default became platform-conditional
    # (CS2-sim-confirmed closed-loop instability on the real CF21BL airframe otherwise).
