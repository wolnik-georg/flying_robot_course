...
//!
//! Uses exponential map for quaternion integration to maintain unit constraint
...
impl Integrator for ExpEulerIntegrator {
    fn step(&self, params: &MultirotorParams, state: &mut MultirotorState, action: &MotorAction) {
        ...
        // More accurate than linear integration, maintains quaternion unit constraint
        // Formula: q(t+dt) = q(t) ⊗ exp(0.5 * ω * dt)
