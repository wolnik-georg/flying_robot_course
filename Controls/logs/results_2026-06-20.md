...
**Representative flight (fc_bw=70 Hz):**

![](figure8_mode1_kt0.008_2026-06-20_12-18-37_analysis.png)
![](figure8_mode1_kt0.008_2026-06-20_12-18-37_analysis_axes.png)
![](figure8_mode1_kt0.008_2026-06-20_12-18-37_analysis_kinematics.png)
![](figure8_mode1_kt0.008_2026-06-20_12-18-37_3d_orientation.png)
![](figure8_mode1_kt0.008_2026-06-20_12-18-37_indi_dashboard.png)
![](figure8_mode1_kt0.008_2026-06-20_12-18-37_indi_panel.png)
![](figure8_mode1_kt0.008_2026-06-20_12-18-37_indi_accel.png)
...
**Representative flight (kr=1050, kw=87 baseline — Geom RMSE 2.2 cm):**
...
**Representative flight (KP=40, KV=3.3 — Geom RMSE 3.9 cm):**

![](figure8_mode1_kt0.05_2026-06-20_14-37-54_analysis.png)
![](figure8_mode1_kt0.05_2026-06-20_14-37-54_analysis_axes.png)
![](figure8_mode1_kt0.05_2026-06-20_14-37-54_analysis_kinematics.png)
![](figure8_mode1_kt0.05_2026-06-20_14-37-54_3d_orientation.png)
![](figure8_mode1_kt0.05_2026-06-20_14-37-54_indi_dashboard.png)
![](figure8_mode1_kt0.05_2026-06-20_14-37-54_indi_accel.png)
...
**Representative INDI flight** (flight 1 — 2.2 cm Geom RMSE, closest to 2.21 cm average):
...
**Representative Geometric flight** (flight 5 — 3.9 cm Geom RMSE, closest to 3.82 cm average):

![](figure8_mode1_kt0.05_2026-06-20_15-10-28_analysis.png)
![](figure8_mode1_kt0.05_2026-06-20_15-10-28_analysis_axes.png)
![](figure8_mode1_kt0.05_2026-06-20_15-10-28_analysis_kinematics.png)
![](figure8_mode1_kt0.05_2026-06-20_15-10-28_3d_orientation.png)
...
| kt   | Lap (s) | Geom RMSE | Phase RMSE | Peak roll | Peak pitch | Result |
|------|---------|-----------|------------|-----------|------------|--------|
| 0.01 | 8.84    | 2.0 cm    | 2.8 cm     | 22.9°     | 16.3°      | ✓ clean |
| 0.02 | 8.07    | **1.9 cm**| 3.4 cm     | 28.0°     | 18.7°      | ✓ best shape RMSE |
| 0.03 | 7.57    | 2.3 cm    | 4.7 cm     | 38.1°     | 16.4°      | ✓ clean |
| 0.04 | 7.19    | 2.6 cm    | 4.0 cm     | 28.4°     | 30.7°      | ✓ clean |
| 0.05 | 6.88    | 3.5 cm    | 5.4 cm     | 62.6°     | 30.0°      | ✓ clean (avg 2.21 cm over 10 flights) |
| 0.10 | 5.90    | 7.3 cm    | 11.3 cm    | 74.2°     | 34.2°      | ✓ barely — tracking degrading |
| 0.60 | 3.46    | 9.1 cm    | 67.0 cm    | 84.6°     | 27.1°      | ✗ crash |
| 0.70 | 3.28    | 143.6 cm  | 159.9 cm   | **100.3°**| 38.9°      | ✗ crash (inverted) |

**Physical limit analysis:**
- At kt=0.10 (lap 5.9s, peak speed ~1.5 m/s): shape RMSE 7.3 cm vs 2.2 cm at kt=0.05 — 3× degradation. Peak roll 74° indicates motors operating near saturation at the figure-8 crossing point.
- At kt=0.60 (lap 3.5s): phase RMSE 67 cm — drone is no longer tracking the trajectory, just trying to stay in the air. Peak roll 85°.
- At kt=0.70 (lap 3.3s): complete loss of control — peak roll 100° (past inverted), RMSE 144 cm. Full crash.

**Conclusion**: the CF2.1 hardware limit is between kt=0.10 and kt=0.60. The **practical tracking ceiling is kt=0.05** (lap 6.9s, avg Geom RMSE 2.21 cm over 10 flights). At kt=0.10 the drone survives but tracking quality collapses — tilt demands exceed what the position loop can deliver while keeping RMSE low. The limiting factor is motor thrust saturation at the tight crossing-point turns, not the INDI inner loop.

Gap not tested: kt=0.20–0.50 (lap 4.9–3.7s). The crash boundary is somewhere in that range.

**kt=0.05 — sweet spot (Geom RMSE 3.5 cm, geometric; lap 6.88s):**

![](figure8_mode1_kt0.05_2026-06-20_15-41-23_analysis.png)
![](figure8_mode1_kt0.05_2026-06-20_15-41-23_analysis_axes.png)
![](figure8_mode1_kt0.05_2026-06-20_15-41-23_analysis_kinematics.png)
![](figure8_mode1_kt0.05_2026-06-20_15-41-23_3d_orientation.png)

**kt=0.10 — tracking degraded (Geom RMSE 7.3 cm, geometric; lap 5.90s, peak roll 74°):**

![](figure8_mode1_kt0.1_2026-06-20_15-44-06_analysis.png)
![](figure8_mode1_kt0.1_2026-06-20_15-44-06_analysis_axes.png)
![](figure8_mode1_kt0.1_2026-06-20_15-44-06_analysis_kinematics.png)
![](figure8_mode1_kt0.1_2026-06-20_15-44-06_3d_orientation.png)
...
**Metrics**: Geom RMSE **2.2 cm** | Phase RMSE **3.6 cm** | Uncalibrated RMSE 16.0 cm | t_shift +160 ms  
...
acc_z mean=1.015 g confirms the drone is flying nearly level-thrust at hover, with peak 1.22 g at the tightest turns (only 22% thrust headroom for manoeuvring). acc_x and acc_y stay very small (std~0.02 g, peak 0.066 g), confirming most of the position control authority comes from attitude tilt rather than parasitic body-frame forces. The low body-lateral acceleration also validates that the trajectory is smooth and the INDI inner loop is not exciting structural resonances.
...
**Position X** — Actual follows the sinusoidal X profile tightly after phase alignment; the along-track lag is the dominant error, not amplitude error. The figure-8 X amplitude is well-reproduced (±1.0 m actual vs ±0.92 m planned — 9% overshoot at the peak), suggesting the position loop is slightly under-damped in X at this speed.
...
**Velocity Vz** — Vz oscillates ±0.23 m/s at the figure-8 frequency; this is induced by the thrust direction tilting during attitude changes (the Z force component changes with cos(tilt)) rather than any Z command. A planned-acceleration Z feedforward term (from the onboard polynomial's Z second derivative) could cancel this; currently KP_Z/KV_Z feedback alone has to compensate.
...
**Acceleration Z** — Very small Z acceleration demand in the planned trajectory (constant altitude), but actual shows ±0.5 m/s² oscillation driven by the attitude tilt coupling noted above. This is the clearest indication that a Z acceleration feedforward would help Z tracking.
...
### 7h. Summary of Issues and Improvement Paths

| Observation | Root Cause | Priority | Fix |
|-------------|-----------|----------|-----|
| 160 ms along-track phase lag | CRTP latency + attitude τ_dom=83 ms — irreducible in current architecture | Low (accept as-is) | Would require sub-5 ms CRTP + <20 ms attitude loop — not feasible on CF2.1 standard radio |
| Y lobe overshoot 27% | Tighter Y radius → more centripetal demand relative to position-loop bandwidth | Medium | Slightly lower KV_XY (e.g. 3.0) to reduce damping, or reduce figure-8 Y scale |
| Battery sag 0.9 V over flight | Normal LiPo 1S sag under load; reduces max thrust during flight | Low | Use fresh cell for each demo; consider 2S upgrade for brushless version |
| Z Vz oscillation ±0.23 m/s | Thrust direction couples into Z when drone tilts; no Z accel feedforward | Medium | Add planned Z acceleration feedforward from onboard polynomial 2nd derivative |
| tau log stale period (~2.7 s at start) | CRTP log variable holds last value from previous power-on until first INDI step overwrites it | ✅ Resolved | `analyze_indi.py` excludes stale period from all stats; dashboard plot masks stale region with NaN so y-axis scales to real signal |
| alp_raw ≈ alp (no visible filter effect) | 70 Hz filter visible only at 500 Hz control rate; 20 Hz log aliases it away | None (not a bug) | Log alp at higher rate to visualise filtering, or reduce fc_bw below ~10 Hz to make effect visible at 20 Hz log rate |
...
**Observation**: actual Y amplitude ±0.57 m vs planned ±0.45 m — a consistent 27% overshoot at the figure-8 lobe tips.

**Root cause**: the Y lobes have a tighter radius than the X crossing, so the centripetal force demand per unit KP error is higher in Y. KV_XY=3.3 provides strong velocity damping that prevents the drone from naturally following the centripetal curve; the position loop has to "catch up" from behind the reference.

**Fix**: reduce `kv_xy: 3.3 → 3.0` in `crazyflies.yaml`. This reduces velocity damping slightly, allowing the drone to lean into the Y turns rather than braking early.

**Effort**: single yaml line change + one validation flight.

**Expected outcome**: Y overshoot reduces to ~10–15%; Geom RMSE may improve by 0.2–0.5 cm. No expected impact on Z or crash risk.

```yaml
# crazyflies.yaml — change this
pos_gains:
  kv_xy: 3.0    # was 3.3
```
...
#### Z Vz Oscillation (±0.23 m/s)

**Observation**: Vz oscillates at the figure-8 lobe frequency (~0.14 Hz, amplitude ±0.23 m/s, peak Z accel ±0.5 m/s²) despite the planned trajectory being constant altitude.

**Root cause**: when the drone tilts to produce centripetal force, the vertical component of thrust changes as `F_z = T·cos(θ)`. With peak tilt 33°, vertical thrust drops by `1 - cos(33°) = 16%`, causing a Z acceleration disturbance of `0.16 × g ≈ 1.6 m/s²`. KP_Z/KV_Z feedback reacts after the fact, producing the observed oscillation.

**Fix**: add a planned Z acceleration feedforward term from the onboard degree-8 polynomial's second time-derivative. The trajectory evaluator (`eval_traj_onboard` in `lib.rs`) already computes 5-tuples including acceleration; the Z component needs to be passed to the position controller as an `a_des_z` feedforward alongside the existing XY acceleration feedforward.

**Effort**: firmware change in `lib.rs` (3–5 lines), rebuild + flash + one validation flight.

**Implementation sketch**:
```rust
// In controller_step, the planned Z acceleration from onboard poly eval:
let az_ff = eval_traj_onboard_z_accel(tick);  // already computed, needs threading through
// Add to f_d:
let f_d = ... .add(Vec3::new(0.0, 0.0, az_ff));
```

**Expected outcome**: Vz std reduces from 0.23 m/s to < 0.05 m/s; Z error std should drop from 0.027 m to < 0.010 m.

---

### 8b. Low Priority (accept for demo)

| Item | Status |
|------|--------|
| 160 ms along-track phase lag | Irreducible in current CRTP + attitude loop architecture. Accept as-is. |
| Battery sag 0.9 V/flight | Use fully charged cell for each demo run; charge between runs. |

---

### 8c. Potential Extensions (post-demo)

| Extension | Motivation |
|-----------|-----------|
| kt sweep gap (kt=0.20–0.50) | Crash boundary is somewhere in this range; narrowing it characterises the hardware limit more precisely |
| DSHOT ESC protocol | Would reduce motor response lag from ~40 ms to ~5 ms, potentially allowing kr/kw to be raised significantly and enabling kt=0.10 tracking quality today |
| Brushless drone (Phase 2) | Higher thrust-to-weight ratio unlocks kt > 0.10 without saturation; architecture already validated |
