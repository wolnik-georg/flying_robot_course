...
- [x] **Sim formation validation matrix** — every Priority A and B scenario, both controllers, automated commanded-vs-realised geometry check. 19/20 pass; B1 under geometric is a correct measurement of downwash, not a defect
