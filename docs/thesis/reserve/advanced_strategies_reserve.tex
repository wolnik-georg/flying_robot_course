...
%
%  2026-09-22: Campaign hybrid (former Strategy 4 / NA-INDI) removed from the compared set.
%  Live thesis compares Strategies 0-3 only. Hybrid prose in BLOCK C/E below is inactive
%  history — not flown, not in C.4.
%
%  WHY THIS FILE EXISTS
%  The thesis compares Strategies 0-3 (baseline, INDI, geometric+NN, FBL). Strategies 5-7 -- residual
...
%       which currently reads "Strategies 0-3".
