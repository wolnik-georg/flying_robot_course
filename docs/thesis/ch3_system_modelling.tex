...
evaluated here. Residual reinforcement learning (Strategies~5 and~7) never forms that number. That
is a property of the method, not a reason to exclude it from a comparison of performance.
...
Strategies~1, 2 and~4 consume it. Strategies~5 and~7 never form it, which is a property of residual
reinforcement learning rather than a reason to exclude it from a comparison of performance. The
