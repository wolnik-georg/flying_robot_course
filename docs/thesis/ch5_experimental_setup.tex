...
Chapter~\ref{ch:control} described Strategies~0--3 (the uncompensated baseline, pure INDI,
geometric+NN and FBL+NN), each treated as its own controller. This chapter describes the platform,
...
\SI{500}{\hertz} independently of team size. Each strategy is tuned on the hardware gate. Those
...
Record any deviation from a per-strategy gain block, frozen after the hardware gate, or from scenario parameters in this chapter.}
