...
Chapter~\ref{ch:control} described Strategies~0--7 (eight controllers: an uncompensated baseline
plus seven families, with residual reinforcement learning split into two variants by inner loop),
each treated as its own controller. This chapter describes the platform, the scenarios, the
measurement chain and the protocol, and
