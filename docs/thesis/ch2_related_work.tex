...
(Section~\ref{sec:rw-inject}) --- it is described briefly rather than in depth. The omission is one
of scope, not of relevance: those families are part of the landscape the gap argument of
Section~\ref{sec:rw-eval} rests on, and Chapter~\ref{ch:control} states where the boundary of this
thesis's own comparison falls and why.
...
multi-robot case, in which the residual is larger and is a function of a measurable relative state,
remains untested for such hybrids; evaluating them on teams is outside the scope of this thesis.
