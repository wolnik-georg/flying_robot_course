...
across strategies wherever the architecture permits. This holds uniformly for every
strategy — none is exempted or held to a looser standard. Where a controller's own structure
