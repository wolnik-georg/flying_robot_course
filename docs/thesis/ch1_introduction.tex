...
consume a force residual use that number; Strategies~5 and~7 do not form it. It gives
...
\textbf{Chapter~\ref{ch:control}} describes Strategies~0--7 (eight controllers: an uncompensated
baseline plus seven families, with residual reinforcement learning split into two variants by inner
loop), and the point at which each
