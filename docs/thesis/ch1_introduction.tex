...
\begin{enumerate}
  \item \textbf{A controlled comparison.} To the best of our knowledge the first evaluation of
    ...
    methodological content is in the word \emph{controlled}. For Strategies 1, 2, 3 and 5 it is
    ...
    anything else. \emph{This does not extend to Strategies 4 and 6}, which are structurally
...
consume a force residual use that number; Strategy~7 does not form it. It gives
...
\textbf{Chapter~\ref{ch:control}} describes Strategies~1--6 plus 7a and 7b (eight controllers; seven families, with residual
reinforcement learning split by inner loop), and the point at which each
