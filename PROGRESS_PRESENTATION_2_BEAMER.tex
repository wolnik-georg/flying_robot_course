...
\begin{frame}{Mode 3 --- Teardrop Loop (3D Trajectory)}
\imgh{flying_drone_stack/results/planning_sim/reference/mode3/teardrop/trajectory_3d_orientation.png}
\end{frame}
...
\begin{frame}{Mode 3 --- Split-S (3D Trajectory)}
\imgh{flying_drone_stack/results/planning_sim/reference/mode3/splits/trajectory_3d_orientation.png}
\end{frame}
